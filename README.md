...
```
curl -OL https://github.com/LimeChain/subtest/releases/download/0.0.11/binary-macos &&
...
```
curl -OL https://github.com/LimeChain/subtest/releases/download/0.0.11/binary-linux &&
